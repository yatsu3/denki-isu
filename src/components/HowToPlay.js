...
const HowToPlay = () => (
  <div className="container">
    ...
    <div style={{ textAlign: 'left', color: '#444', fontSize: '1.15rem', lineHeight: 1.8 }}>
      ...
      <center><img src={`${process.env.PUBLIC_URL}/images/purpose.png`} alt="ゲームの目的" style={{ width: '100%', maxWidth: '250px', marginBottom: '20px' }} /></center>
      ...
      <center><img src={`${process.env.PUBLIC_URL}/images/map.png`} alt="ゲームの流れ" style={{ width: '100%', maxWidth: '250px', marginBottom: '20px' }} /></center>
      <p style={{ marginBottom: '20px', paddingLeft: '15px' }}>
      ...
      <center><img src={`${process.env.PUBLIC_URL}/images/point.png`} alt="ポイントの獲得" style={{ width: '100%', maxWidth: '250px', marginBottom: '20px' }} /></center>
      <p style={{ marginBottom: '20px', paddingLeft: '15px' }}>
      ...
      <center><img src={`${process.env.PUBLIC_URL}/images/lose.png`} alt="電流のペナルティ" style={{ width: '100%', maxWidth: '250px', marginBottom: '20px' }} /></center>
      <p style={{ marginBottom: '20px', paddingLeft: '15px' }}>
      ...
      <center><img src={`${process.env.PUBLIC_URL}/images/winner.png`} alt="勝利条件" style={{ width: '100%', maxWidth: '250px', marginBottom: '20px' }} /></center>
      <p style={{ marginBottom: '20px', paddingLeft: '15px' }}>
      ...
      <center><img src={`${process.env.PUBLIC_URL}/images/11772_color.png`} alt="戦略のヒント" style={{ width: '100%', maxWidth: '200px', marginBottom: '20px' }} /></center>
      <p style={{ marginBottom: '20px', paddingLeft: '15px' }}>
